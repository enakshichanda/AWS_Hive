...
INSERT OVERWRITE DIRECTORY '${OUTPUT}/browser/' SELECT Method, Bytes, '->',COUNT(Bytes)
FROM cloudfront_logs WHERE DateLog BETWEEN '2014-07-05' AND '2014-08-05' GROUP BY Method, Bytes;
