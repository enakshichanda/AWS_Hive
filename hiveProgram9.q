...
INSERT OVERWRITE DIRECTORY '${OUTPUT}/host/' SELECT Host,Uri,Status,Referrer
FROM cloudfront_logs WHERE DateLog BETWEEN '2014-07-05' AND '2014-08-05' GROUP BY Host,Uri,Status,Referrer;
