...
INSERT OVERWRITE DIRECTORY '${OUTPUT}/os_requests2/' SELECT HOUR(Time), '->',COUNT(HOUR(Time))
FROM cloudfront_logs WHERE DateLog BETWEEN '2014-07-05' AND '2014-08-05'GROUP BY HOUR(Time);
